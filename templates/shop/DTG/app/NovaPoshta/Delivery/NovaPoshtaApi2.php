...
class NovaPoshtaApi2
{
    ...
    public function createUser($counterpartyProperty = 'Recipient', $name, $lastname, $middlename, $phone, $email = null)
    {
        $params = [
            'FirstName' => $name,
            'LastName' => $lastname,
    ...
    public function newInternetDocument($sender, $recipient, $params)
    {
        ...
        if (empty($sender['Sender'])) {
		    ...
		    $senderCounterpartyExisting = $this->createUser('Recipient', $sender['FirstName'], $sender['LastName'], $sender['MiddleName'], $sender['Phone'], '');
