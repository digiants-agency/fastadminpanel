<?php if (!empty($pagination)): ?>
    ...
    @if ($showmore && isset($pagination['arrow_right']))
        ...
        <div class="show-more-wrapper" onclick="makePagination(this, true); return false;">
        ...
        <div class="container">
            <div class="pagination">
                ...
                <?php if (isset($pagination['arrow_first'])): ?>
                    <div class="pagination-btn-wrapper" onclick="makePagination(this); return false;">
                        <a 
...
@startjs
<script>
async function makePagination(elm, showmore = false){
